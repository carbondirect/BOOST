...
\textbf{\field{totalVolumeM3}} & number ($\geq$0) & Total volume of the traceable unit in cubic meters \\
...
\field{volumeChangeRatio} & number ($\geq$0, $\leq$2.0) & Ratio of output volume to input volume (1.0 = no change) \\
