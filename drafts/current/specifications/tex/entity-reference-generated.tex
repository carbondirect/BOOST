...
\bottomrule
\endfoot
BioRAM Pathway & Compliance \& Reporting & California BioRAM program pathway for biomass power gener... & 15 \\
BioRAM Reporting & Compliance \& Reporting & Quarterly BioRAM compliance report for biomass power gene... & 20 \\
...
Biometric Identifier & Core Traceability & BiometricIdentifier entity in BOOST data model & 12 \\
Identification Method & Core Traceability & Catalog of available identification methods for Traceable... & 10 \\
Location History & Core Traceability & Historical movement records of TRUs & 14 \\
Material Processing & Core Traceability & Processing operations that transform TRUs with plant part... & 23 \\
Processing History & Core Traceability & Complete timeline of processing events with moisture trac... & 22 \\
Traceable Unit & Core Traceability & Unique biomass tracking unit with BOOST traceability syst... & 27 \\
Geographic Data & Geographic \& Tracking & GeographicData entity in BOOST data model & 10 \\
Tracking Point & Geographic \& Tracking & TrackingPoint entity in BOOST data model & 8 \\
...
Supply Base & Material \& Supply Chain & SupplyBase entity in BOOST data model. Infrastructure dat... & 7 \\
...
Measurement Record & Measurement \& Verification & Quality measurements and dimensional data & 19 \\
...
CertificationScheme & Organizational Foundation & CertificationScheme entity defining certification standar... & 16 \\
Organization & Organizational Foundation & Organization entity with geographic data references and c... & 27 \\
...
Data Reconciliation & \field{transactionId} & Transaction & Foreign key to Transaction entity bei... \\
...
Sales Delivery Document & \field{transactionId} & Transaction & Foreign key to Transaction entity \\
Supplier & \field{supplierId} & Supplier &  \\
Supply Base & \field{OrganizationId} & Organization & Managing organization - uses EntityNa... \\
Supply Base Report & \field{organizationId} & Organization & Foreign key to Organization entity th... \\
Traceable Unit & \field{operatorId} & Operator & Foreign key to operator \\
Tracking Point & \field{operatorId} & Operator & Foreign key to Operator entity \\
