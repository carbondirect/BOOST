% Executive Summary Section for BOOST Specification
% Converted from includes/executive-summary.inc.md
...
\subsubsection{Physical Reality Mapping}
...
\subsubsection{Biometric Automation Benefits}
