...
\field{measurementMethod} & enum(18 values) & Method used for measurement with comprehensive standard values \\
...
\begin{itemize}
    \item \field{transactionId} → \entity{Transaction} (Foreign key to Transaction entity being reconciled)
\end{itemize}
\end{informative}
