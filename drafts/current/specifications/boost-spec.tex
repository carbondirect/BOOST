...
% Version: 2.8.0 - Integrated ERD Navigator + Bikeshed Documentation System

\usepackage{boost-spec-minimal}
...
\hypersetup{
    pdftitle={BOOST Data Standard},
    pdfauthor={BOOST W3C Community Group},
    pdfsubject={Biomass Open Origin Standard for Tracking Data Standard},
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{BOOST Data Standard}
\fancyhead[R]{v2.8.0 - \today}
\fancyfoot[C]{\thepage}
...
% Chapter 8: Serialization and Exchange
\section{Serialization and Exchange}
\label{sec:serialization}
\input{tex/serialization}

% Chapter 9: Use Cases and Requirements
...
% Chapter 11: Resources \& Community
...
\input{tex/entity-reference-generated}
